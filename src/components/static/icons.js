export function Logo ({ width }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 256 262">
...
export function ArrowDropDown ({ width = 32, color = 'currentColor' }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 24 24">
      <path fill={color} d="m12 15l-5-5h10l-5 5Z"/>
    </svg>
  )
}

export function ArrowDropUp ({ width = 32, color = 'currentColor' }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 24 24">
      <path fill={color} d="m7 14l5-5l5 5H7Z"/>
    </svg>
  )
}
